 ...
 */
#define BOARD_AT32F4
#define BOARD_NAME              "WDAQ"
#define BOARD_ID                0x25150000
#define HW_VERSION              0x00000001
#define FW_VERSION              0x25101400

#define EVT_SAVE_NVM            EVENT_MASK(0)
#define EVT_RESTORE_NVM            EVENT_MASK(1)/*
 * Board frequencies.
 */
 ...
 * Port A setup.
 */
#define VAL_GPIOACRL    (PIN_ANALOG(0)            | /* RST_H (not used)*/  \
                         PIN_INPUT_PUD(1)               | /* BUSY 1 */  \
                         PIN_ALTERNATE_PP_50(2)               | /* BUSY H (not used) */  \
                         PIN_INPUT_PUD(3)            | /* LOAD ALL */  \
...
#define VAL_GPIOBCRL    (PIN_INPUT_PUD(0)               | /* ALARM 3  */  \
                         ...
                         PIN_ALTERNATE_OD_10(6)               | /* TMPALM (not use)          */  \
                         PIN_ALTERNATE_OD_10(7))                /* CGALM (not use)          */
 ...
 * Port C setup.
 */
#define VAL_GPIOCCRL    (PIN_ALTERNATE_PP_50(0)               | /* not use  */                    \
                         PIN_ALTERNATE_PP_50(1)               | /* not use  */                          \
                         PIN_ALTERNATE_PP_50(2)             | /* not use  */                          \
                         PIN_ALTERNATE_PP_50(3)             | /* not use  */                          \
                         PIN_ALTERNATE_PP_50(4)               | /* not use  */ \
                         PIN_ALTERNATE_PP_50(5)             | /* not use  */                         \
                         PIN_OUTPUT_OD_2(6)               | /* BUSY 4  */  \
                         PIN_OUTPUT_OD_2(7))              /* CMUX A1     */
#define VAL_GPIOCCRH    (PIN_OUTPUT_PP_2(8)             | /* SYNC 4   */  \
                         PIN_OUTPUT_PP_2(9)             | /* CMUX A0          */  \
                         PIN_OUTPUT_OD_2(10)        | /* not use          */  \
                         PIN_INPUT_PUD(11)              | /* not use    */  \
                         PIN_ALTERNATE_PP_50(12)        | /* not use         */  \
                         PIN_INPUT_PUD(13)           | /* not use     */  \
                         PIN_OUTPUT_PP_50(14)           | /* OSC IN.            */  \
                         PIN_INPUT_PUD(15))               /* OSC OUT.           */
#define VAL_GPIOCODR    0xFFFFDF3F
...
#define J3_POWER_ON()   palClearPad(GPIOC,7)
#define J3_POWER_OFF()  palSetPad(GPIOC,7)
#define J4_POWER_ON()   palClearPad(GPIOC,6)
#define J4_POWER_OFF()  palSetPad(GPIOC,6)
#define LED_ON()        palClearPad(GPIOC,10)
#define LED_OFF()       palSetPad(GPIOC,10)
