 ...
 * Port A setup.
 */
#define VAL_GPIOACRL    (PIN_INPUT(0)       | /* On Board NTC */  \
                         PIN_INPUT(1)    | /* ADXL_INT1 */  \
                         PIN_INPUT(2)    | /* ADXL_INT2 */  \
                         PIN_INPUT(3)    | /* ADXL DRDY */  \
                         PIN_INPUT(4)    | /* SPI1_CS (ADXL)*/            \
                         PIN_INPUT(5) | /* SPI1_SCK.          */  \
                         PIN_INPUT(6) | /* SPI1_MISO.         */  \
                         PIN_INPUT(7))  /* SPI1_MOSI.         */
...
#define VAL_GPIOCCRL    (PIN_UNDEFINED(0)       |                           \
                         ...
                         PIN_OUTPUT_PP_2(5)       |                           \
                         PIN_OUTPUT_PP_2(6)    | /* SmartCard CMDVCC.  */  \
...
#define VAL_GPIOCODR    0xFFFFDC3F
