 ...
 */
#define BOARD_AT32F4
#define BOARD_NAME              "REMOTE_IO_RX_V02"
 ...
 * Port A setup.
 */
#define VAL_GPIOACRL    (PIN_OUTPUT_OD_50(0)       | /* On Board NTC */  \
                         PIN_OUTPUT_PP_10(1)    | /* ADXL_INT1 */  \
                         PIN_OUTPUT_PP_10(2)    | /* ADXL_INT2 */  \
                         PIN_OUTPUT_PP_10(3)    | /* ADXL DRDY */  \
                         PIN_OUTPUT_PP_10(4)    | /* SPI1_CS (ADXL)*/            \
                         PIN_OUTPUT_PP_10(5) | /* SPI1_SCK.          */  \
                         PIN_OUTPUT_PP_10(6) | /* SPI1_MISO.         */  \
                         PIN_OUTPUT_PP_10(7))  /* SPI1_MOSI.         */
#define VAL_GPIOACRH    (PIN_OUTPUT_OD_50(8) | /* I2C2.SCL              */  \
                         ...
                         PIN_OUTPUT_PP_10(15))     /* SMU_STB               */
#define VAL_GPIOAODR    0xFFFFF8D0

/*
 * Port B setup.
 */
#define VAL_GPIOBCRL    (PIN_ANALOG(0)    | /* BMI160_CS  */  \
                         PIN_ANALOG(1)      | /* BMI160 INT2*/  \
                         PIN_INPUT_PUD(2)      | /* BMI160 INT1*/  \
                         PIN_OUTPUT_OD_50(3)           | /* TDO.               */  \
                         PIN_OUTPUT_OD_50(4)           | /* TRST.              */  \
                         PIN_OUTPUT_OD_50(5)       | /* CAN2_RX  */  \
                         PIN_OUTPUT_OD_50(6) | /* I2C1_SCL          */  \
...
#define VAL_GPIOCCRL    (PIN_UNDEFINED(0)       |                           \
                         ...
                         PIN_OUTPUT_OD_50(7))            /* SmartCard OFF.     */
#define VAL_GPIOCCRH    (PIN_OUTPUT_OD_50(8) | /* SDIO D0.           */  \
                         PIN_OUTPUT_PP_10(9) | /* I2C2.SDA           */  \
