 ...
 * Port A setup.
 */
#define VAL_GPIOACRL    (PIN_OUTPUT_PP_2(0)       | /* On Board NTC */  \
                         PIN_OUTPUT_PP_2(1)    | /* ADXL_INT1 */  \
                         PIN_OUTPUT_PP_2(2)    | /* ADXL_INT2 */  \
                         PIN_OUTPUT_PP_2(3)    | /* ADXL DRDY */  \
                         PIN_UNDEFINED(4)    | /* SPI1_CS (ADXL)*/            \
                         PIN_OUTPUT_PP_2(5) | /* SPI1_SCK.          */  \
...
#define VAL_GPIOCCRH    (PIN_OUTPUT_PP_2(8) | /* SDIO D0.           */  \
